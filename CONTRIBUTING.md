...
- Adding new formulae or improving existing ones
...
4. Test your changes thoroughly. For formula changes, verify the formula installs and works correctly (`brew install --build-from-source ./Formula/<formula>.rb`, `brew test <formula>`, and `brew audit --strict <formula>`).
...
- Your formula changes are properly tested
